...
class CveOasVulnerabilitiesInnerCveMetricsCvssMetricV31Inner(ModelNormal):
    ...
    def _from_openapi_data(cls, source, type, cvss_data, *args, **kwargs):  # noqa: E501
        """CveOasVulnerabilitiesInnerCveMetricsCvssMetricV31Inner - a model defined in OpenAPI

...
class CpeOasProductsInnerCpe(ModelNormal):
    ...
    attribute_map = {
        ...
        'cpe_name_id': 'cpeNameId',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, deprecated, cpe_name, cpe_name_id, created, last_modified, *args, **kwargs):  # noqa: E501

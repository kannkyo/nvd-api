...
from nvd_api import rest
from nvd_api.configuration import Configuration
from nvd_api.exceptions import ApiTypeError, ApiValueError, ApiException
from nvd_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_cpe_match  # this is an instance of the class Endpoint
        api_instance.get_cpe_match()  # this invokes api_instance.get_cpe_match.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_cpe_match.callable or self.callable in this class

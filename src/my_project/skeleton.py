...
def __parse_args(args):
    ...
    _logger.debug("parse args {}".format(parsed_args))
    return parsed_args
...
def __setup_logging(loglevel):
    ...
    _logger.debug("set log level {}".format(loglevel))
...
def main(args):
    ...
    print("The {}-th Fibonacci number is {}".format(args.n, __fib(args.n)))
